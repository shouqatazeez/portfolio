...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "Full-stack job board with role-based access for Seekers and Employers, multi-filter search, one-click applications, employer applicant management panel, and CI/CD deployment via GitHub Actions.",
      technologies: [
        "Next.js",
        "TypeScript",
        "React",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/shouqatazeez/jobhive",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
